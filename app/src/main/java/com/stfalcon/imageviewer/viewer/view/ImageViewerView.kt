...
internal class ImageViewerView<T> @JvmOverloads constructor(
    ...
    override fun setBackground(drawable: Drawable) {
        findViewById<View>(R.id.backgroundView).setBackground(drawable)
    }
    ...
    private fun hideSystemUI() {
        ...
        val decorView: View = (context as Activity).getWindow().getDecorView()
    ...
    fun sendDialog(dialog1: AlertDialog) {
        dialog = dialog1
    }
}