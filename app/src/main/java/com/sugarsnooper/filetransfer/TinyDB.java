...
//    public void putListObject(String key, Object objArray){
//        checkForNullKey(key);
//        Gson gson = new Gson();
//        ArrayList<String> objStrings = new ArrayList<String>();
//        ArrayList<Object> objects = (ArrayList<Object>) objArray;
...
//    public <T>Object getListObject(String key, Object objectType){
//        checkForNullKey(key);
//        Gson gson = new Gson();
//        ArrayList <Object> objects = new ArrayList<>();
//        for (String s : getListString(key)){
//            objects.add(gson.fromJson(s, objectType.getClass()));
//        }
//
//        return objects;
//    }
    ...
    public void putListMedia (String key, ArrayList<Media> media) {
        ArrayList<String> nameList = new ArrayList<>(getListString(key + "_name"));
        ArrayList<String> uriList = new ArrayList<>(getListString(key + "_uri"));
        ArrayList<Long> fileSizeList = new ArrayList<>(getListLong(key + "_size"));
        for (Media m : media) {
            try {
                uriList.add(m.getUri().toString());
                nameList.add(m.getName());
                fileSizeList.add(m.getSize());
            }
            catch (NullPointerException ne){

            }
        }
        putListString(key + "_name", nameList);
        putListString(key + "_uri", uriList);
        putListLong(key + "_size", fileSizeList);
    }

    public ArrayList<Media> getListMedia(String key) {
        ArrayList<Media> mediaArrayList = new ArrayList<>();
        ArrayList<String> nameList = getListString(key + "_name");
        ArrayList<String> uriList = getListString(key + "_uri");
        ArrayList<Long> fileSizeList = getListLong(key + "_size");
        if (nameList.size() == uriList.size() && uriList.size() == fileSizeList.size()) {
            int size = nameList.size();
            for (int i = 0; i < size; i++) {
                mediaArrayList.add(new Media(Uri.parse(uriList.get(i)), nameList.get(i), fileSizeList.get(i)));
            }
